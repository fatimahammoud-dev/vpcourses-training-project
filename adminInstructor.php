...
$sql = "SELECT * FROM `admininstructor`";
$result = $conn->query($sql);
$instructor = $result->fetch_all(MYSQLI_ASSOC);
            ...
            <div class="container-fluid pt-4 min-vh-100 bg-light">
                <div class="row ms-2">
                    ...
                    <a href="index.php" style="color: black;">
                        <p>Home
                    </a> <span style="color: #f6de64;"> / <a href="adminInstructor.php" style="color:#f6de64">All
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="addAdminInstructor.php" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="d-flex align-items-center float-end">
                                                    <button type="submit" class="btn me-4 " style="background-color:red; border-radius:4px; letter-spacing:1px;font-weight:bold ">
                                                        <a href="adminInstructor.php" style="color:white;">Close</a>
                                                    </button>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr class="text-center">
                                                <td id="userIDCell" hidden><?php echo $i['id']; ?></td>
                                                <td id="image" style="width: 30%;">
                                                    <img src="vpCourses/img/instructors/<?php echo $i['image'] ?>" width="40%" alt="">
                                                </td>
                                                <td id="courseCell"><?php echo $i['course']; ?></td>

                                                <td id="instructorCell"><?php echo $i['name']; ?></td>
                                                <td>
                                                    <a href="#" onclick="confirmDelete(<?php echo $i['id']; ?>, '<?php echo $i['name']; ?>');">
                                                        ...
                                                        function confirmDelete(id, courseName) {
                                                            swal.fire({
                                                                ...
                                                                if (result.isConfirmed) {
                                                                    window.location.href = 'deleteAdminInstructor.php?id=' + id;
                                                                }
                                                            });
                                                        }
                                                    </script>
                                                    <a href="updateFormAdminInstructor.php?id=<?php echo $i['id']; ?>" title="Update"><i class=" fa-solid fa-pen-to-square" style="color: green;"></i></a>
                                                </td>
                                            </tr>
                                        <?php
                                        } ?>
